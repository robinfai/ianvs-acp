...
import 'chat_permission_request.dart';
...
String redactedPermissionTitleForAudit(ChatPermissionRequest request) {
  final display = _permissionCommandDisplayForAudit(request);
  return display == null ? request.title : 'Command: $display';
}

String redactedPermissionRationaleForAudit(ChatPermissionRequest request) {
  return _commandFromPermissionRequest(request) == null
      ? request.rationale
      : 'Command details withheld from audit.';
}

String? _permissionCommandDisplayForAudit(ChatPermissionRequest request) {
  final invocation = _commandFromPermissionRequest(request);
...
bool _isExplicitCommandPermission(ChatPermissionRequest request) {
