...
import 'package:ianvs_agent_chat/models/chat_session_settings.dart';
...
void main() {
  ...
  Widget input({
    ...
    ChatToolCallExecutionPolicy toolCallExecutionPolicy =
        ChatToolCallExecutionPolicy.autoReview,
    bool hasPermissionReviewer = false,
    ValueChanged<ChatToolCallExecutionPolicy>? onToolCallExecutionPolicyChanged,
    ChatConfigOption? modelOption,
    ChatConfigOption? reasoningEffortOption,
    ValueChanged<String>? onModelSelected,
    ValueChanged<String>? onReasoningEffortSelected,
    List<ChatConfigOption> configOptions = const <ChatConfigOption>[],
  ...
  testWidgets('PromptInput query cap honors the injected structured limit', (
    ...
    const budget = ChatInputBudget(maxStructuredStringBytes: 8);
    await tester.pumpWidget(
      input(
        isSending: false,
        onSend: (_, _) {},
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      List<PromptAttachment>? sentAttachments;
      const capabilities = ChatPromptCapabilities(
        image: true,
        audio: false,
        embeddedContext: false,
      );
  ...
  testWidgets('PromptInput resets context scroll for a new request instance', (
    ...
    Widget prompt(ChatPermissionRequest pendingRequest) => input(
      isSending: false,
      onSend: (_, _) {},
      ...
      await tester.pumpWidget(
        input(
          ...
          pendingPermissionRequest: ChatPermissionRequest(
            ...
            choices: const <ChatPermissionChoice>[
              ...
              ChatPermissionChoice(optionId: 'fallback-reject', name: 'Reject'),
              ChatPermissionChoice(optionId: 'fallback-allow', name: 'Allow'),
              ChatPermissionChoice(
    ...
    (tester) async {
      await tester.pumpWidget(
        input(
          ...
          modelOption: const ChatConfigOption(
            id: 'model',
            name: 'Model',
            type: 'select',
  ...
  testWidgets('PromptInput changes tool call execution policy', (tester) async {
    ChatToolCallExecutionPolicy? selected;
    await tester.pumpWidget(
      input(
        isSending: false,
        onSend: (_, _) {},
    ...
    expect(selected, ChatToolCallExecutionPolicy.fullAccess);
  });
    ...
    await tester.pumpWidget(
      input(
        ...
        modelOption: const ChatConfigOption(
          ...
          currentValue: 'gpt-5',
          options: [
            ChatConfigOptionChoice(value: 'gpt-5', name: 'GPT-5'),
            ChatConfigOptionChoice(value: 'mini', name: 'GPT-5 Mini'),
          ],
        ),
  ...
  testWidgets('PromptInput keeps model and reasoning choices separate', (
    ...
    await tester.pumpWidget(
      input(
        ...
        onModelSelected: (_) {},
        reasoningEffortOption: const ChatConfigOption(
          id: 'reasoning_effort',
          name: 'Reasoning Effort',
          type: 'select',
          currentValue: 'high',
          options: [
            ChatConfigOptionChoice(value: 'low', name: 'Low'),
            ChatConfigOptionChoice(value: 'high', name: 'High'),
          ],
        ),
      ...
      input(
        ...
        configOptions: const [
          ...
          ChatConfigOption(
            ...
            options: [
              ChatConfigOptionChoice(value: 'low', name: 'Low'),
              ChatConfigOptionChoice(value: 'medium', name: 'Medium'),
              ChatConfigOptionChoice(value: 'high', name: 'High'),
            ],
          ),
          ChatConfigOption(
          ...
          ChatConfigOption(
            ...
            currentValue: 'agent',
            options: [
              ChatConfigOptionChoice(value: 'read-only', name: 'Read-only'),
              ChatConfigOptionChoice(value: 'agent', name: 'Agent'),
            ],
          ),
        ],
  ...
  testWidgets('PromptInput wraps composer controls in narrow widths', (
    ...
    await tester.pumpWidget(
      input(
        ...
        isSending: false,
        onSend: (_, _) {},
        toolCallExecutionPolicy: ChatToolCallExecutionPolicy.fullAccess,
        onToolCallExecutionPolicyChanged: (_) {},
        modelOption: const ChatConfigOption(
          id: 'model',
          name: 'Model',
