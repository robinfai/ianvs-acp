...
void main() {
  ...
  test('ACP input budget exposes stable defensive defaults', () {
    ...
    expect(budget.maxStructuredUpdateBytes, 1024 * 1024);
    expect(budget.maxStructuredStringBytes, 64 * 1024);
    expect(budget.maxMessageTextBytes, 1024 * 1024);
    ...
    expect(budget.maxEmbeddedMediaBytes, 8 * 1024 * 1024);
    ...
    expect(budget.maxTurnRetainedBytes, 16 * 1024 * 1024);
    expect(budget.maxTimelineItems, 2000);
    expect(budget.maxTimelineBytes, 16 * 1024 * 1024);
    expect(budget.maxUiStateBytes, 64 * 1024 * 1024);
