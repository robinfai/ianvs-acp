...
void main() {
  testWidgets('PermissionHistoryView exports audit entries as JSON', (
    tester,
  ) async {
  ...
  testWidgets('PermissionHistoryView disables export when empty', (
    tester,
  ) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(body: PermissionHistoryView(entries: [])),
      ),
    );
