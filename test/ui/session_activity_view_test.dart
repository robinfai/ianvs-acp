...
import 'package:ianvs_acp/ui/components/session_activity_view.dart';
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(body: SessionActivityView(controller: controller)),
        ),
      );
...
Review the screenshot''',
  ...
  testWidgets('activity dialog labels a limited trajectory as latest', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: SessionActivityView(controller: controller, maxEntries: 2),
        ),
      ),
    );
    await tester.pump();
