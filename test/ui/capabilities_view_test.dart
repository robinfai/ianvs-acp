...
import 'package:ianvs_acp/ui/components/capabilities_view.dart';

void main() {
  testWidgets('CapabilitiesView renders negotiated ACP capabilities', (
    tester,
  ) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(body: CapabilitiesView(capabilities: capabilities)),
      ),
    );

    expect(find.text('Negotiated capability status'), findsOneWidget);
    expect(
      find.text(
  ...
  testWidgets('CapabilitiesView renders empty disconnected state', (
    tester,
  ) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(body: CapabilitiesView(capabilities: null)),
      ),
    );
  ...
  testWidgets(
    'CapabilitiesView caches raw previews across rebuilds and collapse',
    (tester) async {
  ...
  testWidgets(
    'CapabilitiesView exposes exact and plus-one preview boundaries',
    (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: CapabilitiesView(
  ...
  testWidgets(
    'CapabilitiesView reports invalid raw data without calling toString',
    (tester) async {
