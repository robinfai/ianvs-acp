        ...
        children: [
          ...
          _InventorySection(
            ...
            rows: [
              ...
              _InventoryValue('Session', session == null ? 'none' : session.id),
              _InventoryValue(
                'Mode',
          ...
          _InventorySection(
            ...
            rows: [
              ...
              _InventoryValue('Filesystem', _filesystemLabel(runtimeConfig)),
              _InventoryValue(
                'Terminal',
          ...
          ExpansionTile(
            title: const Text('Capability details'),
            children: [
              CapabilitiesView(
