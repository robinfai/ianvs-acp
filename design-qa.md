...
> 2026-09-09 设置调整的阶段验收摘要，记录于 `997b246`；下文通过结论与测试数仅属于该轮，不是整个应用的持续验收状态。当前说明见[文档导航](docs/README.md)。
...
- 旧生成稿验收归档于[历史报告](docs/settings-redesign-2026-09-09/design-qa-imagegen.md)。本文件保留该次设置调整的视觉标准及最终结论。
