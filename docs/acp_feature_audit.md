...
lookups are also tied to the active agent. The Rust `memory-core` daemon owns
local storage, review state, search, audit history, embeddings, and its stdio
MCP bridge.
