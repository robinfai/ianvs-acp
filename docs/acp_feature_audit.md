...
| ACP Registry | https://agentclientprotocol.com/get-started/registry | Not implemented | Official Registry browsing/import/install is intentionally out of scope for this protocol-compatibility pass. The app continues to use explicit `settings.json` agent server configuration, with Registry tracked as product follow-up. |
