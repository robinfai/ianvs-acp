...
void main() {
  setUpAll(() async {
    ...
    await Future.wait([
      (FontLoader(AppTypography.family)..addFont(
  ...
  testWidgets(
    'capture macOS settings density refinement',
    (tester) async {
      // Headless screenshots render Flutter content only. Native AppKit
      // materials are checked separately in the CUA window captures.
      ...
      Future<void> capture(String name) async {
        ...
        await expectLater(
          ...
          matchesGoldenFile('screenshots/widget/$name.png'),
        );
      }
